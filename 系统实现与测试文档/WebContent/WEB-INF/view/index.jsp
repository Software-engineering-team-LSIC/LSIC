	...
	<nav class="navbar bg-success" >
	  <div class="container-fluid">
	    ...
	    <div class="navbar-header">
	      ...
	      <a class="navbar-brand" href="#">NEU校园论坛</a>
	    </div>
...
<div class="container-fluid" >
	<div class="bm bmw  flg cl con01" style="background-color: #ffffff;" >
      <div class="bm_h cl" style="position: relative;background-color: #ffffff;" >
        ...
        <h4 >
        	<i class="jg"></i>
			<a href="javascript:void(0)">LIFE 生活 专区</a>
        </h4>
      </div>
            ...
            <c:choose>
            	<c:when test="${not empty java }">
            		<c:forEach items="${java }" var="forum" varStatus="vs">
            			...
            			<!--每三个多一行  -->
            			<!-- ************************************************************ -->
            			<c:if test="${vs.index%3 eq 0  and vs.index <= 4 }">
            				<tr class="fl_row">
            			</c:if>
            			<!-- ************************************************************ -->
            				...
            				<td class="fl_g" width="32.9%">
            					<div class="fl_icn_g" style="width: 120px;">
				                  ...
				                  <c:if test="${vs.index eq 0 }">
				                  	<img src="<%=basePath%>image/daiqukuaidi.png" alt="代取快递" align="left">
				                  	<!-- alt是为了图片没有加载出来时候的代替文本 -->
				                  </c:if>
				                  <c:if test="${vs.index eq 1 }">
				                  	<img src="<%=basePath%>image/ershoujiaoyi.png" alt="二手交易" align="left">
				                  </c:if>
				                  <c:if test="${vs.index eq 2 }">
				                  	<img src="<%=basePath%>image/zuzhufangwu.png" alt="租住房屋" align="left">
				                  </c:if>
				                  <c:if test="${vs.index eq 3 }">
				                  	<img src="<%=basePath%>image/zutuan.png" alt="组团" align="left">
				                  </c:if>
				                  <c:if test="${vs.index eq 4 }">
				                  	<img src="<%=basePath%>image/jianzhi.png" alt="兼职" align="left">
				                  </c:if>
				                  </a>
				                </div>
...
<div class="bm bmw  flg cl con02" style="background-color: #ffffff;">
      <div class="bm_h cl" style="position: relative;background-color: #ffffff;">
        ...
        <h4 >
        	<i class="jg"></i>
			<a href="javascript:void(0)">STUDY 学习 专区</a>
        </h4>
      </div>
            ...
            <c:choose>
            	<c:when test="${not empty java }">
            		<c:forEach items="${java }" var="forum" varStatus="vs" >
            			<c:set var="endTr" value="3"></c:set>
            			<!-- ************************************************************ -->
            			<c:if test="${(vs.index-5)%3 eq 0 and vs.index eq 5}">
            				<tr class="fl_row">
            			</c:if>
            			<!-- ************************************************************ -->
            			<c:if test="${vs.index eq 5}"> <!-- ************************************************************ -->
            				<td class="fl_g" width="32.9%">
            					<div class="fl_icn_g" style="width: 120px;">
				                  ...
				                  <!-- ************************************************************ -->
				                  <c:if test="${vs.index eq 5 }">
				                  	<img src="<%=basePath%>image/yanjiusheng.png" alt="考研/保研" align="left">
				                  </c:if>
				                  <!-- ************************************************************ -->
				                  </a>
				                </div>
...
<div class="bm bmw  flg cl con02" style="background-color: #ffffff;">
      <div class="bm_h cl" style="position: relative;background-color: #ffffff;">
        ...
        <h4 >
        	<i class="jg"></i>
			<a href="javascript:void(0)">INFORMATION 资源 专区</a>
        </h4>
      </div>
            ...
            <c:choose>
            	<c:when test="${not empty java }">
            		<c:forEach items="${java }" var="forum" varStatus="vs" >
            			<c:set var="endTr" value="3"></c:set>
            			<!-- ************************************************************ -->
            			<c:if test="${(vs.index-6)%3 eq 0 and vs.index eq 6}">
            				<tr class="fl_row">
            			</c:if>
            			<!-- ************************************************************ -->
            			<c:if test="${vs.index eq 6}"> <!-- ************************************************************ -->
            				<td class="fl_g" width="32.9%">
            					<div class="fl_icn_g" style="width: 120px;">
				                  ...
				                  <!-- ************************************************************ -->
				                  <c:if test="${vs.index eq 6 }">
				                  	<img src="<%=basePath%>image/ziyuan.png" alt="资源" align="left">
				                  </c:if>
				                  <!-- ************************************************************ -->
				                  </a>
				                </div>
...
<div class="bm bmw  flg cl con02" style="background-color: #ffffff;">
      <div class="bm_h cl" style="position: relative;background-color: #ffffff;">
        ...
        <h4 >
        	<i class="jg"></i>
			<a href="javascript:void(0)">COMMUNICATION 交流 专区</a>
        </h4>
      </div>
            ...
            <c:choose>
            	<c:when test="${not empty java }">
            		<c:forEach items="${java }" var="forum" varStatus="vs" >
            			<c:set var="endTr" value="3"></c:set>
            			<!-- ************************************************************ -->
            			<c:if test="${(vs.index-7)%3 eq 0 and vs.index >= 7}">
            				<tr class="fl_row">
            			</c:if>
            			<!-- ************************************************************ -->
            				...
            				<td class="fl_g" width="32.9%">
            					<div class="fl_icn_g" style="width: 120px;">
				                  ...
				                  <c:if test="${vs.index eq 7 }">
				                  	<img src="<%=basePath%>image/ziliao.png" alt="东大资料" align="left">
				                  </c:if>
				                  <c:if test="${vs.index eq 8 }">
				                  	<img src="<%=basePath%>image/baozhi.png" alt="报纸" align="left">
				                  </c:if>
				                  <c:if test="${vs.index eq 9 }">
				                  	<img src="<%=basePath%>image/huodong.png" alt="活动" align="left">
				                  </c:if>
				                  <!-- ************************************************************ -->
				                  </a>
				                </div>
	...
	<footer class="footer bg-info">
	    <div class="container" >
	    	<div class="row">
	                <div class="col-sm-12">
	                    <span><a href="http://www.mingrisoft.com/">LSIC团队</a></span> | 
	                    <span>GitHub：<a href="https://github.com/Software-engineering-team-LSIC">https://github.com/Software-engineering-team-LSIC</a></span>
	                </div>
	                <br />
	                <br />
	         </div>
