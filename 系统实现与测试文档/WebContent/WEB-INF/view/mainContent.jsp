		...
		<div class="col-xs-2 text-right">
			<c:choose>
				<c:when test="${mainType eq 'javase'}">
					<img alt="" src="<%=basePath %>secondImage/daiqukuaidi.png">
				</c:when>
				<c:when test="${mainType eq 'jianzhi'}">
					<img alt="" src="<%=basePath %>secondImage/jianzhi.png">
				</c:when>
				<c:when test="${mainType eq 'yanjiusheng'}">
					<img alt="" src="<%=basePath %>secondImage/yanjiusheng.png">
				</c:when>
				<c:when test="${mainType eq 'ziyuan'}">
					<img alt="" src="<%=basePath %>secondImage/ziyuan.png">
				</c:when>
				<c:when test="${mainType eq 'dongdaziliao'}">
					<img alt="" src="<%=basePath %>secondImage/ziliao.png">
				</c:when>
				<c:when test="${mainType eq 'baozhi'}">
					<img alt="" src="<%=basePath %>secondImage/baozhi.png">
				</c:when>
				<c:when test="${mainType eq 'huodong'}">
					<img alt="" src="<%=basePath %>secondImage/huodong.png">
				</c:when>
				<c:when test="${mainType eq 'php'}">
					<img alt="" src="<%=basePath %>secondImage/ershoujiaoyi.png">
				</c:when>
				<c:when test="${mainType eq 'net'}">
					<img alt="" src="<%=basePath %>secondImage/zuzhufangwu.png">
				</c:when>
				<c:when test="${mainType eq 'jsp'}">
					<img alt="" src="<%=basePath %>secondImage/zutuan.png">
				</c:when>
				<c:otherwise>
